"""
Django settings for ficc project.
...
SECRET_KEY = '2t8@wdzlk*jw*%vr2@g7*=o)r&hn1e^=+c$*twebe&_0l)$mk4'
...
WSGI_APPLICATION = 'ficc.wsgi.application'
...
STATICFILES_DIRS = [
    ("archivos", "/home/zariguella/git/FICC/ficc/templates/lumino/"),
]
